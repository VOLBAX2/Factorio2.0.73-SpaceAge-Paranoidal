...
bobmods.lib.tech.add_prerequisite("logistic-science-pack", "angels-liquid-molten-bronze")
...
bobmods.lib.tech.add_recipe_unlock("angels-basic-chemistry-2", "dirt-water-separation")
bobmods.lib.tech.add_recipe_unlock("angels-basic-chemistry-2", "catalyst-metal-carrier")
bobmods.lib.tech.add_recipe_unlock("angels-basic-chemistry-2", "catalyst-metal-red")
--###############################################################################################
--целюлозное волокно в переработку древесины
bobmods.lib.tech.add_recipe_unlock("angels-bio-wood-processing", "cellulose-fiber-raw-wood")
-------------------------------------------------------------------------------------------------
...
bobmods.lib.tech.add_prerequisite("angels-liquid-molten-invar", "bob-zinc-processing") --сталь
...
bobmods.lib.tech.remove_recipe_unlock("angels-liquid-molten-invar", "bob-invar-alloy-x")
...
bobmods.lib.tech.remove_recipe_unlock("angels-liquid-molten-invar", "intermediate-structure-components")
...
bobmods.lib.tech.remove_recipe_unlock("angels-liquid-molten-cobalt-steel", "bob-cobalt-steel-alloy-x")
...
bobmods.lib.tech.add_prerequisite("bob-drills-2", "angels-liquid-molten-cobalt-steel") --буры3 под кобальт
bobmods.lib.tech.add_prerequisite("bob-area-drills-2", "angels-liquid-molten-cobalt-steel") --буры3 под кобальт
...
bobmods.lib.tech.add_prerequisite("gunships", "angels-liquid-molten-cobalt-steel") --самолёты под кобальт
...
bobmods.lib.tech.add_prerequisite("angels-liquid-molten-brass", "ore-floatation") -- Латунь под Гидропромывку 1
--21.07.24
...
bobmods.lib.tech.add_recipe_unlock("angels-liquid-molten-nitinol", "bob-nitinol-pipe")
bobmods.lib.tech.remove_recipe_unlock("bob-nitinol-processing", "bob-nitinol-pipe")
bobmods.lib.tech.remove_recipe_unlock("angels-liquid-molten-nitinol", "angels-nitinol-pipe-casting")
bobmods.lib.tech.add_recipe_unlock("bob-nitinol-processing", "angels-nitinol-pipe-casting")
bobmods.lib.tech.add_recipe_unlock("angels-liquid-molten-nitinol", "bob-nitinol-pipe-to-ground")
bobmods.lib.tech.remove_recipe_unlock("bob-nitinol-processing", "bob-nitinol-pipe-to-ground")
bobmods.lib.tech.remove_recipe_unlock("angels-liquid-molten-nitinol", "angels-nitinol-pipe-to-ground-casting")
