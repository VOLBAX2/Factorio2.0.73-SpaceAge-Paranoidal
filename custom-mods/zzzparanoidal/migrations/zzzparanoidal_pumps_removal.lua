...
local offshore_pump_types = {
    ...
    "offshore-mk3-pump", "offshore-mk4-pump", "angels-seafloor-pump", 
}

for _, surface in pairs(game.surfaces) do
    for _, entity in pairs(surface.find_entities_filtered{name = {"offshore-mk0-pump-output", "offshore-pump-output", "offshore-mk2-pump-output", "offshore-mk3-pump-output", "offshore-mk4-pump-output", "seafloor-pump-output" }}) do
