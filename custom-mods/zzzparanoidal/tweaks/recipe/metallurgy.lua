...
--рубит
paralib.bobmods.lib.recipe.set_energy_required("angels-ore5-crushed-smelting", 20)
paralib.bobmods.lib.recipe.set_ingredient("angels-ore5-crushed-smelting", { type = "item", name = "angels-ore5-crushed", amount = 7})
paralib.bobmods.lib.recipe.set_result("angels-ore5-crushed-smelting", { type = "item", name = "bob-lead-plate", amount = 4 })
paralib.bobmods.lib.recipe.add_result("angels-ore5-crushed-smelting", { type = "item", name = "angels-slag", amount = 1})
--бобмониум
paralib.bobmods.lib.recipe.set_energy_required("angels-ore6-crushed-smelting", 20)
paralib.bobmods.lib.recipe.set_ingredient("angels-ore6-crushed-smelting", { type = "item", name = "angels-ore6-crushed", amount = 7})
paralib.bobmods.lib.recipe.set_result("angels-ore6-crushed-smelting", { type = "item", name = "bob-tin-plate", amount = 4 })
paralib.bobmods.lib.recipe.add_result("angels-ore6-crushed-smelting", { type = "item", name = "angels-slag", amount = 1})
