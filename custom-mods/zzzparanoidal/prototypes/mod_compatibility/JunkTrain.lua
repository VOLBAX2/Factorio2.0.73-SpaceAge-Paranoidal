if mods["JunkTrain3"] then
			...
			stop_trigger = {
				...
				},
				{
					...
					sound = {
						...
						{ filename = "__base__/sound/train-brake-screech-2.ogg", volume = 0.3 },
					},
				},
			},
			working_sound = {
	...
	data.raw["train-stop"]["train-stop-scrap"].icons = {
		{
			icon = "__base__/graphics/icons/train-stop.png",
			icon_size = 64,
			icon_mipmaps = 4,
	...
	data.raw["train-stop"]["train-stop-scrap"].animations.north.layers[1].filename =
		"__zzzparanoidal__/graphics/train/train-stop-bottom.png"
	data.raw["train-stop"]["train-stop-scrap"].animations.east.layers[1].filename =
		"__zzzparanoidal__/graphics/train/train-stop-bottom.png"
	data.raw["train-stop"]["train-stop-scrap"].animations.south.layers[1].filename =
		"__zzzparanoidal__/graphics/train/train-stop-bottom.png"
	data.raw["train-stop"]["train-stop-scrap"].animations.west.layers[1].filename =
		"__zzzparanoidal__/graphics/train/train-stop-bottom.png"

	data.raw["train-stop"]["train-stop-scrap"].rail_overlay_animations.north.filename =
		"__zzzparanoidal__/graphics/train/train-stop-ground.png"
	data.raw["train-stop"]["train-stop-scrap"].rail_overlay_animations.east.filename =
		"__zzzparanoidal__/graphics/train/train-stop-ground.png"
	data.raw["train-stop"]["train-stop-scrap"].rail_overlay_animations.south.filename =
		"__zzzparanoidal__/graphics/train/train-stop-ground.png"
	data.raw["train-stop"]["train-stop-scrap"].rail_overlay_animations.west.filename =
		"__zzzparanoidal__/graphics/train/train-stop-ground.png"
end
