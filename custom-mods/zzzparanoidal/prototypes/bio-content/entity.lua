...
local assembler2pipepicturesBioreactor = {
	north = {
		filename = "__Bio_Industries_2__/graphics/icons/empty.png",
		priority = "extra-high",
		width = 1,
		height = 1,
...
data:extend({ -- ###############################################################################################
	-- Greenhouse MK2
	{
		...
		energy_source = {
			...
			drain = "15kW",
			emissions_per_minute = { pollution = -12, spores = -12 },
		},
		energy_usage = "100kW",
		ingredient_count = 3,
		resistances = { {
	...
	}, -- Greenhouse MK3
	{
		...
		energy_source = {
			...
			usage_priority = "primary-input",
			drain = "15kW",
			emissions_per_minute = { pollution = -18, spores = -18 },
		},
		energy_usage = "150kW",
		ingredient_count = 3,
		resistances = { {
		...
		fluid_boxes = {
			{
				...
				base_area = 10,
				base_level = -1,
				pipe_connections = { { direction = 8, flow_direction = "input", position = { 0, -1 } } },
			},
		},
		module_specification = {
			module_slots = 3,
	...
	-- Bio Farm MK3
	{
		...
		energy_source = {
			...
			usage_priority = "primary-input",
			drain = "50kW",
			emissions_per_minute = { pollution = -27, spores = -27 },
		},
		energy_usage = "300kW",
		ingredient_count = 3,
		open_sound = {
