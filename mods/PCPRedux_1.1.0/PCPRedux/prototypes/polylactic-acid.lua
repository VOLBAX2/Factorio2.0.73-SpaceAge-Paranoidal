  ...
  data:extend(
    {
      ...
      },
      {
        ...
        results = {
          ...
          { type = "fluid", name = "angels-liquid-sulfuric-acid", amount = 100 },
        },
        order = "g",
        icons = {
          {
      ...
      },
      {
        ...
        ingredients = {
          ...
          { type = "fluid", name = "angels-liquid-sulfuric-acid", amount = 300 },
        ...
        crafting_machine_tint = angelsmods.functions.get_fluid_recipe_tint("bacterial-growth-seed" or
        "liquid-lactic-acid"),
        icon_size = 32,
      },
      {
