function fillMulunaConfig(config)
	config.muluna = {}
	
	local mulunaConfig = config.muluna
	
	mulunaConfig["metallic-asteroid-chunk"] =
	{
		type="resource-ore",
	...
	mulunaConfig["oxide-asteroid-chunk"] =
	{
		type="resource-ore",
	...
	mulunaConfig["carbonic-asteroid-chunk"] =
	{
		type="resource-ore",
