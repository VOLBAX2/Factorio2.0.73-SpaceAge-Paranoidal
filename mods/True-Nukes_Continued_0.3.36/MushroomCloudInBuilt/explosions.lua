data:extend({
		...
		filename = "__True-Nukes_Continued__/MushroomCloudInBuilt/sound/nuclear_detonation_close_proximity.ogg",
		volume = 2.0
	},
    	{
		type = "sound",
		...
		variations = {
			...
			{
                		filename = "__True-Nukes_Continued__/MushroomCloudInBuilt/sound/nuclear_detonation_in_vincinity_2.ogg",
                		volume = 1.75
            		}
		}
	},
	{
		...
		variations = {
            		{
				filename = "__True-Nukes_Continued__/MushroomCloudInBuilt/sound/nuclear_explosion_distant_boom_1.ogg",
				volume = 1.75
    			},
		    	{
				filename = "__True-Nukes_Continued__/MushroomCloudInBuilt/sound/nuclear_explosion_distant_boom_2.ogg",
				volume = 1.6
		    	},
		    	{
				filename = "__True-Nukes_Continued__/MushroomCloudInBuilt/sound/nuclear_explosion_distant_boom_3.ogg",
				volume = 1.75
		    	}   
		}
	},
		...
		filename = "__True-Nukes_Continued__/MushroomCloudInBuilt/sound/nuclear_detonation_far_away.ogg",
		volume = 2.0
	}
})
