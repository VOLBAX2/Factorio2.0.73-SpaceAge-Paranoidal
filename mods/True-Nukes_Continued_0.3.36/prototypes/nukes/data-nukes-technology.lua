local appearance = require("__Warheads_Continued__.prototypes.appearance-util")
...
data.raw.technology["atomic-bomb"].prerequisites = {"basic-atomic-weapons", "processing-unit", "rocket-fuel", "rocketry"}
...
data.raw.technology["atomic-bomb"].icon = "__True-Nukes_Continued__/graphics/nuke-tech.png"
...
data:extend{
  {
    ...
    icon = "__True-Nukes_Continued__/graphics/nuke-tech-basic.png",
    effects =
    {
  ...
  data:extend{
    {
      ...
      icon_size = 256, icon_mipmaps = 4,
      icon = "__True-Nukes_Continued__/graphics/atomic-artillery-tech.png",
      effects = {},
    ...
    data:extend{
      {
        ...
        icon_size = 256, icon_mipmaps = 4,
        icon = "__True-Nukes_Continued__/graphics/californium-processing-tech.png",
        effects =
        {
          {
            type = "unlock-recipe",
  ...
  data:extend{
    {
      ...
      icon_size = 256, icon_mipmaps = 4,
      icon = "__True-Nukes_Continued__/graphics/small-atomic-tech.png",
      effects = {},
      prerequisites = {},
      unit =
      {
  ...
  data:extend{
    {
      ...
      icon_size = 256, icon_mipmaps = 4,
      icon = "__True-Nukes_Continued__/graphics/many-small-atomic-tech.png",
      effects =
      {
        {
          type = "unlock-recipe",
  ...
  data:extend{
    {
      ...
      icon_size = 256, icon_mipmaps = 4,
      icon = "__True-Nukes_Continued__/graphics/many-atomic-tech.png",
      effects = {},
  ...
  data:extend{
    {
      ...
      icon = "__True-Nukes_Continued__/graphics/tritium-processing.png",
      effects =
      {
        {
          type = "unlock-recipe",
    ...
    },
    {
      ...
      name = "fusion-weapons",
      icon_size = 256, icon_mipmaps = 1,
      icon = "__True-Nukes_Continued__/graphics/fusion-bomb.png",
      effects = {
        {
          type = "unlock-recipe",
          recipe = "FOGBANK"
  ...
  data:extend{
    {
      ...
      icons = {
        {icon = "__Warheads_Continued__/graphics/blank-64.png", icon_size = 64, scale = 1, shift = {0, -0}},
        {icon = "__True-Nukes_Continued__/graphics/californium-processing-tech.png", icon_size = 256, scale = 0.125, shift = {12, -12}, icon_mipmaps = 4},
        {icon = "__base__/graphics/technology/kovarex-enrichment-process.png", icon_size = 256, scale = 0.125, shift = {-12, -12}, icon_mipmaps = 4},
        {icon = "__True-Nukes_Continued__/graphics/tritium-processing.png", icon_size = 256, scale = 0.125, shift = {0, 16}, icon_mipmaps = 4},
        {icon = "__True-Nukes_Continued__/graphics/plus-red.png", icon_size = 32, scale = 0.5, shift = {24, -24}},
      },
      effects =
      {
        {
