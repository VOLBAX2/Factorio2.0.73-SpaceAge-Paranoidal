...
local BLT_force_condition = settings.startup[cfg1.mod_prefix .. "bullet-force-condition"].value
...
local function BLT_ammo(spec)
  local item =
  {
    ...
    stack_size = spec.ammo.stack_size or 100,
    weight = spec.ammo.weight or 10*kg,
  }
  if BLT_proj then
