...
tankMG.name = "Schall-tank-machine-gun-single"
...
tankAC.name = "Schall-tank-autocannon"
tankAC.attack_parameters.ammo_category = "Schall-autocannon-shell" --"cannon-shell"
...
tankCH1.name = "Schall-tank-cannon-H1"
tankCH1.icon = nil
tankCH1.icons = { {icon = "__base__/graphics/icons/tank-cannon.png"},
                  TPlib.caliber_icon_layer[1] }
tankCH1.attack_parameters.ammo_category = "Schall-cannon-H1-shell" --"cannon-shell"
...
tankCH2.name = "Schall-tank-cannon-H2"
tankCH2.icon = nil
tankCH2.icons = { {icon = "__base__/graphics/icons/tank-cannon.png"},
                  TPlib.caliber_icon_layer[2] }
tankCH2.attack_parameters.ammo_category = "Schall-cannon-H2-shell" --"cannon-shell"
