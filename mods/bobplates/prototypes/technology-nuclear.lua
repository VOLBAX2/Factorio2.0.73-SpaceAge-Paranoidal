...
bobmods.lib.tech.add_prerequisite("nuclear-power", "bob-lead-processing")
...
data:extend({
  ...
  },
  {
    ...
    icon = "__bobplates__/graphics/icons/technology/thorium-nuclear-fuel-reprocessing-new.png",
    icon_size = 128,
    effects = {
      {
        type = "unlock-recipe",
...
data:extend({
...

  {
    ...
    icon = "__bobplates__/graphics/icons/technology/deuterium-nuclear-fuel-reprocessing-new.png",
    icon_size = 128,
    order = "e-p-b-e3",
    prerequisites = {
      "bob-nuclear-power-3",
