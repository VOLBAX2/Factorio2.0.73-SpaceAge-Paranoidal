...
bobmods.lib.tech.add_recipe_unlock("titanium-processing", "advanced-structure-components")
bobmods.lib.tech.add_recipe_unlock("tungsten-processing", "anotherworld-structure-components")
