...
data:extend({
	...
	},
	{
		...
		ingredients = {
			...
			{ type = "item", name = "cobalt-steel-alloy", amount = 9},
	...
	},
	{
		...
		energy_required = 30,
		ingredients = {
			{ type = "item", name = "basic-electronic-components", amount = 48},
			{ type = "item", name = "electronic-components", amount = 18},
	...
	},
	{
		...
		energy_required = 45,
		ingredients = {
			{ type = "item", name = "basic-electronic-components", amount = 20},
			{ type = "item", name = "electronic-components", amount = 40},
			{ type = "item", name = "condensator2", amount = 16},
			{ type = "item", name = "intergrated-electronics", amount = 15},
	...
	},
	{
		...
		energy_required = 60,
		ingredients = {
			{ type = "item", name = "basic-electronic-components", amount = 28},
			{ type = "item", name = "electronic-components", amount = 52},
			{ type = "item", name = "intergrated-electronics", amount = 24},
	...
	},
	{
		...
		ingredients = {
			...
			{ type = "item", name = "basic-electronic-components", amount = 36},
			{ type = "item", name = "electronic-components", amount = 40},
			{ type = "item", name = "intergrated-electronics", amount = 32},
			{ type = "item", name = "processing-electronics", amount = 16},
...
data:extend({
	{
		...
		hidden = true,
		energy_required = 5,
		ingredients = { { type = "item", name = "empty-barrel", amount = 5} },
