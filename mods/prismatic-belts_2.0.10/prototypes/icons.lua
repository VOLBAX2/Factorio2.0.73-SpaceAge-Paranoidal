...
-- Note: lifted from Artisanal Reskins: Library; need to take the time and extract these to a
-- standalone icon utility mod.
...
---```
---@class PrismaticBelts.Api.Icons
local icons_api = {}
...
---*@throws* `string` — Thrown when `icon_datum.icon` is not a mod-prefixed absolute file path with a valid extension.<br/>
...
---
---### Parameters
---@param deferred_icons { [PrismaticBelts.Api.Defines.Stage]: (DeferrableIconData|DeferrableIconDatum)[] } # The dictionary of deferrable icons, indexed by stage, to add the deferrable icon to.
---@param stage PrismaticBelts.Api.Defines.Stage # The key to the data stage to store the deferrable icon in.
...
---
---### See Also
---@see PrismaticBelts.Api.Icons.assign_icons_deferred_to_stage
...
---
---### See Also
---@see PrismaticBelts.Api.Icons.assign_icons_to_prototype_and_related_prototypes
...
---
---### Parameters
---@param deferred_icons { [PrismaticBelts.Api.Defines.Stage]: (DeferrableIconData|DeferrableIconDatum)[] } # The dictionary of deferrable icons, indexed by stage, to assign the deferrable icons from.
---@param stage PrismaticBelts.Api.Defines.Stage # The index of the data stage to source deferrable icons from.
---
---### Exceptions
---*@throws* `string` — Thrown when a deferred icon's `name` field is `nil` or an empty string.<br/>
---*@throws* `string` — Thrown when a deferred icon's `type_name` field is `nil` or an empty string.<br/>
...
---
---### See Also
---@see PrismaticBelts.Api.Icons.store_icon_for_deferred_assignment_in_stage
---@see PrismaticBelts.Api.Icons.assign_deferrable_icon
...
---
---### See Also
---@see PrismaticBelts.Api.Icons.add_missing_icon_defaults
---@nodiscard
function icons_api.combine_icons(is_technology_icon, ...)
	---@type data.IconData[]
...
---
---### See Also
---@see PrismaticBelts.Api.Icons.add_missing_icons_defaults
---@see PrismaticBelts.Api.Icons.get_icon_from_prototype_by_reference
---@nodiscard
...
---
---### See Also
---@see PrismaticBelts.Api.Icons.add_icons_from_prototype_to_icons_by_reference
---@nodiscard
...
---@see PrismaticBelts.Api.Icons.add_missing_icons_defaults
---@see PrismaticBelts.Api.Icons.add_missing_icon_defaults
---@see PrismaticBelts.Api.Icons.get_icon_from_prototype_by_name
---@nodiscard
...
function icons_api.create_and_assign_combined_icons_from_sources_to_recipe(recipe_icon_source_map)
