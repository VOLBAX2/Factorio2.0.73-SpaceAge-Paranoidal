...
clowns.functions.add_to_table("clowns-centrifuging-20pc-ore",{type = "item", name = "angels-uranium-234", amount = 1, probability = 0.000055},"res")
--update angels nuclear cells
