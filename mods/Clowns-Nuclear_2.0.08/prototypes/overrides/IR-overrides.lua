if mods["IndustrialRevolution3"] then
	--update train fuel
	clowns.functions.replace_ing("nuclear-fuel","uranium-235", {"55pc-uranium", 1}, "ing")
	--update reactor fuel
	clowns.functions.replace_ing("uranium-fuel-cell","uranium-235", {"35pc-uranium", 20}, "ing")
	...
	--data.raw.recipe["nuclear-fuel-reprocessing"].ingredients={{"depleted-uranium-fuel-cell",1}}--change it to 5
	--update kovarex
