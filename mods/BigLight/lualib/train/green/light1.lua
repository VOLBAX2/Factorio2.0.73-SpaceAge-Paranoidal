...
return
{
  ...
  picture =
  {
    north = { layers = {
        {
          filename = "__BigLight__/graphics/entity/train-stop/vert/train-stop-north-light-1.png",
          width = 9,
          height = 5,
          frame_count = 1,
    ...
    west = { layers = {
      {
        filename = "__BigLight__/graphics/entity/train-stop/vert/train-stop-east-light-1.png",
        width = 3,
        height = 9,
        frame_count = 1,
    ...
    south = { layers = {
      {
        filename = "__BigLight__/graphics/entity/train-stop/vert/train-stop-south-light-1.png",
        width = 8,
        height = 2,
        frame_count = 1,
    ...
    east = { layers = {
      {
        filename = "__BigLight__/graphics/entity/train-stop/vert/train-stop-west-light-1.png",
        width = 3,
        height = 8,
        frame_count = 1,
