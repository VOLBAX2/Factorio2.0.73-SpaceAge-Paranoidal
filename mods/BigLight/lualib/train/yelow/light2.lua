return
{
  ...
  picture =
  {
    north = { layers = {
      {
        filename = "__BigLight__/graphics/entity/train-stop/jaune/train-stop-north-light-2.png",
        width = 9,
        height = 5,
        frame_count = 1,
        ...
        --[[ hr_version =
        {
          filename = "__BigLight__/graphics/entity/train-stop/jaune/hr-train-stop-north-light-2.png",
          width = 16,
          height = 9,
          frame_count = 1,
    ...
    west = { layers = {
      {
        filename = "__BigLight__/graphics/entity/train-stop/jaune/train-stop-east-light-2.png",
        width = 3,
        height = 8,
        frame_count = 1,
        ...
        --[[ hr_version =
        {
          filename = "__BigLight__/graphics/entity/train-stop/jaune/hr-train-stop-east-light-2.png",
          width = 6,
          height = 16,
          frame_count = 1,
          shift = util.by_pixel(34.5, 10),
    ...
    south = { layers = {
      {
        filename = "__BigLight__/graphics/entity/train-stop/jaune/train-stop-south-light-2.png",
        width = 8,
        height = 3,
        frame_count = 1,
        ...
        --[[ hr_version =
        {
          filename = "__BigLight__/graphics/entity/train-stop/jaune/hr-train-stop-south-light-2.png",
          width = 16,
          height = 5,
          frame_count = 1,
    ...
    east = { layers = {
      {
        filename = "__BigLight__/graphics/entity/train-stop/jaune/train-stop-west-light-2.png",
        width = 4,
        height = 8,
        frame_count = 1,
        ...
        --[[ hr_version =
        {
          filename = "__BigLight__/graphics/entity/train-stop/jaune/hr-train-stop-west-light-2.png",
          width = 7,
          height = 15,
          frame_count = 1,
