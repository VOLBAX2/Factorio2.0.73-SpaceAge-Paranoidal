...
if data.raw["technology"]["physical-projectile-damage-7"] then
	table.insert(data.raw["technology"]["physical-projectile-damage-7"].effects, {type = "turret-attack", turret_id = "w93-scattergun-turret", modifier = 0.1})
end
if data.raw["technology"]["physical-projectile-damage-11"] then
	table.insert(data.raw["technology"]["physical-projectile-damage-11"].effects, {type = "turret-attack", turret_id = "w93-scattergun-turret", modifier = 0.1})
end
if data.raw["technology"]["physical-projectile-damage-16"] then
	table.insert(data.raw["technology"]["physical-projectile-damage-16"].effects, {type = "turret-attack", turret_id = "w93-scattergun-turret", modifier = 0.1})
end
