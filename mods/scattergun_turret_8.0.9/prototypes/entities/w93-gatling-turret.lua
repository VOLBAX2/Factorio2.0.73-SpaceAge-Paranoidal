...
local function gatling_turret_attack(inputs)
	return
	{
		layers =
		{
			...
			{
				filename = "__scattergun_turret__/graphics/entity/gatling-turret/hr-gatling-turret-gun.png",
				priority = "very-low",
				width = 172,
				height = 160,
				run_mode = inputs.run_mode or "forward",
			...
			},
			{
				...
				{
					{
						filename = "__scattergun_turret__/graphics/entity/gatling-turret/gatling-turret-gun-shadow-1.png",
          					width_in_frames = inputs.frame_count or 1,
						height_in_frames = 18
					},
					{
						filename = "__scattergun_turret__/graphics/entity/gatling-turret/gatling-turret-gun-shadow-2.png",
          					width_in_frames = inputs.frame_count or 1,
						height_in_frames = 18
					},
				},
...
local function gatling_turret2_attack(inputs)
	return
	{
		layers =
		{
...
data:extend({
{
	...
	minable = {mining_time = 0.5, result = "w93-gatling-turret"},
	max_health = 1500,
	...
	folded_animation = gatling_turret_attack{},
	preparing_animation = gatling_turret_attack{},
	prepared_animation = gatling_turret_attack{},
	attacking_animation = gatling_turret_attack{},
	folding_animation = gatling_turret_attack{run_mode = "backward"},
	...
	fast_replaceable_group = "modular-turret-bullet",
	next_upgrade = "w93-gatling-turret2",
	...
	attack_parameters =
	{
		...
		cooldown = 3,
		damage_modifier = 2.0,
		projectile_creation_distance = 1.3,
		...
		{
			{
				filename = "__scattergun_turret__/sound/gatling-turret-fire.wav",
				volume = 0.35
			}
		}
	},
...
},
{
	...
	icon = "__scattergun_turret__/graphics/icons/gatling-turret2.png",
    	icon_size = 64,
	flags = {"placeable-player", "player-creation", "building-direction-8-way"},
	minable = {mining_time = 0.5, result = "w93-gatling-turret2"},
	max_health = 600,
	corpse = "medium-remnants",
	collision_box = {{-1.2, -1.2 }, {1.2, 1.2}},
	selection_box = {{-1.3, -1.3 }, {1.3, 1.3}},
	...
	folded_animation = gatling_turret2_attack{},
	preparing_animation = gatling_turret2_attack{},
	prepared_animation = gatling_turret2_attack{},
	attacking_animation = gatling_turret2_attack{},
	folding_animation = gatling_turret2_attack{run_mode = "backward"},
	...
	fast_replaceable_group = "modular-turret-bullet",
	next_upgrade = "w93-gatling-turret",
