...
local function cannon_turret_attack(inputs)
	return
	{
		layers =
		{
			...
			{
				filename = "__scattergun_turret__/graphics/entity/dcannon-turret/hr-dcannon-turret-gun.png",
				priority = "very-low",
				width = 240,
				height = 240,
				run_mode = inputs.run_mode or "forward",
			...
			},
			{
				...
				{
					{
						filename = "__scattergun_turret__/graphics/entity/dcannon-turret/dcannon-turret-gun-shadow-1.png",
          					width_in_frames = inputs.frame_count or 1,
						height_in_frames = 9
					},
					{
						filename = "__scattergun_turret__/graphics/entity/dcannon-turret/dcannon-turret-gun-shadow-2.png",
          					width_in_frames = inputs.frame_count or 1,
						height_in_frames = 9
					},
					{
						filename = "__scattergun_turret__/graphics/entity/dcannon-turret/dcannon-turret-gun-shadow-3.png",
          					width_in_frames = inputs.frame_count or 1,
						height_in_frames = 9
					},
					{
						filename = "__scattergun_turret__/graphics/entity/dcannon-turret/dcannon-turret-gun-shadow-4.png",
          					width_in_frames = inputs.frame_count or 1,
						height_in_frames = 9
					},
				},
...
data:extend({
{
	...
	next_upgrade = "w93-dcannon-turret2",
...
},
{
	...
	icon = "__scattergun_turret__/graphics/icons/dcannon-turret2.png",
    	icon_size = 64,
	flags = {"placeable-player", "player-creation", "building-direction-8-way"},
	minable = {mining_time = 0.5, result = "w93-dcannon-turret2"},
	max_health = 600,
	corpse = "medium-remnants",
	collision_box = {{-1.2, -1.2 }, {1.2, 1.2}},
	selection_box = {{-1.3, -1.3 }, {1.3, 1.3}},
	...
	fast_replaceable_group = "modular-turret-cannon",
	next_upgrade = "w93-dcannon-turret",
