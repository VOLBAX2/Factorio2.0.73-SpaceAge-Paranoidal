	...
	return
	{
		layers =
		{
			...
			},
			{
				...
				{
					{
						filename = "__scattergun_turret__/graphics/entity/hcannon-turret/hcannon-turret-gun-shadow-1.png",
          					width_in_frames = inputs.frame_count or 1,
						height_in_frames = 9
					},
					{
						filename = "__scattergun_turret__/graphics/entity/hcannon-turret/hcannon-turret-gun-shadow-2.png",
          					width_in_frames = inputs.frame_count or 1,
						height_in_frames = 9
					},
					{
						filename = "__scattergun_turret__/graphics/entity/hcannon-turret/hcannon-turret-gun-shadow-3.png",
          					width_in_frames = inputs.frame_count or 1,
						height_in_frames = 9
					},
					{
						filename = "__scattergun_turret__/graphics/entity/hcannon-turret/hcannon-turret-gun-shadow-4.png",
          					width_in_frames = inputs.frame_count or 1,
						height_in_frames = 9
					},
				},
...
data:extend({
{
	...
	minable = {mining_time = 0.5, result = "w93-hcannon-turret"},
	max_health = 1500,
	...
	attack_parameters =
	{
		...
		{
			{
				filename = "__scattergun_turret__/sound/hcannon-turret-fire.wav",
				volume = 0.85
			}
		}
	},
...
},
{
	...
	icon = "__scattergun_turret__/graphics/icons/hcannon-turret2.png",
    	icon_size = 64,
	flags = {"placeable-player", "player-creation", "building-direction-8-way"},
	minable = {mining_time = 0.5, result = "w93-hcannon-turret2"},
	max_health = 600,
	corpse = "medium-remnants",
	collision_box = {{-1.2, -1.2 }, {1.2, 1.2}},
	selection_box = {{-1.3, -1.3 }, {1.3, 1.3}},
